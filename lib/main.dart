  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        theme: ThemeData(
            ...
            primarySwatch: Colors.cyan), //finthemedata
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('PRODUCTOS de IZZI'),
      ), //findeappbar
      body: Center(
        child: Text("Seccion Total"),
      ), //finbody
    ); //fin de scaffold
  } //fin widget context
...
class Inicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        padding: EdgeInsets.only(top: 130, bottom: 20, right: 10, left: 10),
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/Miguel-naranjo/proyecto_figma/master/assets/images/2b12075b49383164b658c34224580ba662374c46.png"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
